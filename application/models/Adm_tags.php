...
class Adm_tags extends CI_Model {
    ...
    function _get_crud_model ()
    {
        ...
        $opts['sort_field'] = array('tag_name');
        $opts['ui_sort_field'] = '';
        ...
        $group = $this->cms_user->get_group_id();
        $user = $this->cms_user->get_user_id();

        // Фильтрация вывода
        $opts['filters'] = array();
	    $opts['filters'][] = "tag_lang_id = '" . $this->session->userdata('w_alang') . "'";
        ...
        $opts['fdd']['tag_name'] = array(
            ...
            'required'      => true,
            'sort'          => true,
            'help'          => 'Введите название тега.'
        );

        // ------------------------------------------------------------------------

        $opts['fdd']['tag_lang_id'] = array(
            'name'          => 'Язык',
            'select'        => 'T',
            'options'       => 'ACPH',
            'maxlen'        => 3,
